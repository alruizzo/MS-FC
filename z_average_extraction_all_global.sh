...
do
  ...
  cd $i
    fslstats $i/${SUBJECT}_0004.nii.gz -l 0 -M >> $OUTPUTFOLDER/01_global_FC_IC5_RFPN.txt
    fslstats $i/${SUBJECT}_0005.nii.gz -l 0 -M >> $OUTPUTFOLDER/02_global_FC_IC6_PDMN.txt
    fslstats $i/${SUBJECT}_0006.nii.gz -l 0 -M >> $OUTPUTFOLDER/03_global_FC_IC7_SMN2.txt
    fslstats $i/${SUBJECT}_0007.nii.gz -l 0 -M >> $OUTPUTFOLDER/04_global_FC_IC8_LFPN.txt
    fslstats $i/${SUBJECT}_0010.nii.gz -l 0 -M >> $OUTPUTFOLDER/05_global_FC_IC11_ADMN.txt
    fslstats $i/${SUBJECT}_0011.nii.gz -l 0 -M >> $OUTPUTFOLDER/06_global_FC_IC12_SMN1.txt
    fslstats $i/${SUBJECT}_0023.nii.gz -l 0 -M >> $OUTPUTFOLDER/07_global_FC_IC24_BG.txt
done
